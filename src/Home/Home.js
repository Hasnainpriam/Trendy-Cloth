                    ...
                    <section className="max-w-screen-2xl px-4 md:px-8 mx-auto">
                        <div className="flex flex-wrap justify-between mb-8 md:mb-16">
                            <div className="w-full lg:w-1/3 flex flex-col justify-center lg:pt-48 lg:pb-24 mb-6 sm:mb-12 lg:mb-0">
                                ...
                                <p className="max-w-md text-gray-500 xl:text-lg leading-relaxed">Trendy Cloth embodies the spirit of today’s youth that is playful, fashion & value conscious..</p>
                            </div>
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
                            <div className="w-64 h-12 flex border rounded-lg overflow-hidden divide-x">
                                <Link to='/' className="w-1/3 flex justify-center items-center hover:bg-gray-100 active:bg-gray-200 text-gray-500 transition duration-100">Men</Link>
                                <Link to='/' className="w-1/3 flex justify-center items-center hover:bg-gray-100 active:bg-gray-200 text-gray-500 transition duration-100">Women</Link>
                                <Link to='/' className="w-1/3 flex justify-center items-center hover:bg-gray-100 active:bg-gray-200 text-gray-500 transition duration-100">Teens</Link>
                            </div>
